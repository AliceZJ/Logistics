...
<html>
  <head>
    ...
    <title>My JSP 'addgointo.jsp' starting page</title>
  ...
  <tr>
    ...
    <td align="center"><input type="text" name="go_id" id="go_id" value=""></td>
  </tr>
  <tr>
    <td align="center">仓管人员</td>
    <td align="center"><input type="text" name="cangguan_id" id="cangguan_id" value=""></td>
  </tr>
 <tr>
    <td align="center">入库时间</td>
    <td align="center"><input type="text" name="go_date" id="go_date" value=""></td>
  </tr>
  <tr>
    <td align="center">入库状态</td>
    <td align="center"><input type="text" name="go_state" id="go_state" value=""></td>
  </tr>
  <tr>
