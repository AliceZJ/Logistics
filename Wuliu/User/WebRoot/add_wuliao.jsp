...
function checkid(){
	...
	if(null == id||"" == id){
		...
		document.getElementById("show1").innerHTML="ok";
...
<hr>
	...
	<div>
		<center>
        <form action="save_addinfo?opt=1" method="post" onsubmit="return checkall();">
			<table border="1" bordercolor="#99CCCC" cellspacing="0"
				...
				<tr>
				    ...
				    <input name="norms" id="name2" type="text" style="font-size:16px" onblur="checknorms()"></td>
					<td width="200" id="show3">&nbsp;</td>
				</tr>
				<tr>
					<td>重量</td>
					<td><input name="weight" id="weight" type="text" style="font-size:16px" onblur="checkweight()"></td>
					<td width="200" id="show4">&nbsp;</td>
				</tr>
				<tr>
				  <td>单位</td>
				  <td><input name="unit" id="unit" type="text" style="font-size:16px" onblur="checkunit()"></td>
				  <td id="show5">&nbsp;</td>
			  </tr>
				<tr>
				  <td>体积</td>
				  <td><input name="volume" id="volume" type="text" style="font-size:16px" onblur="checkvolume()"></td>
				  <td id="show6">&nbsp;</td>
			  </tr>
				<tr>
				  <td>物料数量</td>
				  <td><input name="count" id="count" type="text" style="font-size:16px" onblur="checkcount()"></td>
				  <td id="show7">&nbsp;</td>
			  </tr>
				<tr align="center">
                	<td colspan="3">
