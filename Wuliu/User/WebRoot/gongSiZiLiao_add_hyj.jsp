...
<body>
	...
	<div>
		<center>
			<form action="servlet/save_gongsiziliao" method="post"
				...
				<table border="1" bordercolor="#99CCCC" cellspacing="0"
					...
					<tr>
						...
						<td><input name="id" id="id" type="text"
							style="font-size:16px" onblur="checkid()">
						</td>
					...
					<tr>
						<td>所属行业</td>
						<td><select name="hangye" style="width:190" id="hangye"
							onblur="checkhy()">
					...
					<tr>
						<td>成立时间</td>
						<td><input name="time" id="time" type="text"
							style="font-size:16px" onblur="checktime()" onclick="showtime()">
						</td>
						<td width="200" id="show4">&nbsp;</td>
					</tr>
					<tr>
						<td>法人代表</td>
						<td><input name="legal" id="legal" type="text"
							style="font-size:16px" onblur="checklegal()">
						</td>
						<td width="200" id="show5">&nbsp;</td>
					</tr>
					<tr align="center">
						<td colspan="3"><input type="submit" value="保存" id="save"
							onClick="checkall()"> &nbsp; <input type="button"
							value="返回" id="back"
							onClick="location.href='javascript:history.go(-1);'"></td>
