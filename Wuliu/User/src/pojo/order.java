...
public order(Integer order_id, pojo.customer customer, String order_type,
		...
		String order_date, String tihuo_date, String tihuo_type, String luru_man,
...
public void setOrder_date(String ord_date) {
	this.order_date = ord_date;
}
public String getTihuo_date() {
	return tihuo_date;
}
public void setTihuo_date(String tihuo_date2) {
	this.tihuo_date = tihuo_date2;
}
